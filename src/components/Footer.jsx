        ...
        <footer className='bg-gradient-to-br from-[#002B36] to-[#004D40] text-white pt-16 pb-8 transition-all'>
                        ...
                        <div className='bg-white/10 p-2 rounded-xl backdrop-blur-sm inline-block'>
                            <div className='flex items-center gap-2'>
                                ...
                                <div className='text-white'>
                                    <p className='font-bold text-lg leading-none tracking-tight'>RS Path Lab</p>
                                    <p className='text-[10px] text-gray-300 tracking-widest uppercase'>Diagnostic Center</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <p className='text-gray-300 text-sm leading-relaxed mb-6'>
                        Your trusted partner for accurate diagnostics and timely results.
                        We offer a comprehensive range of services including advanced blood tests,
                        MRI, CT scans, X-rays, and customized Health Check-up Packages.
                    </p>
                    ...
                    <div>
                        ...
                        <ul className='space-y-4 text-gray-400 text-sm'>
                            <li className='flex items-start gap-3'>
                                ...
                                <span>LBSM Road, Harharguttu,<br />Jamshedpur, 831002</span>
                            </li>
                            <li className='flex items-center gap-3'>
                                <span className='text-xl'>📞</span>
                                <span>+91 95083 83139</span>
                            </li>
                            <li className='flex items-center gap-3'>
                                <span className='text-xl'>📧</span>
            ...
            <div className='border-t border-teal-900 pt-8'>
                <p className='text-center text-sm text-gray-400'>
                    Copyright © 2024 Dr Lal Pathlabs Clone. All Rights Reserved.<br />
                    <span className='text-xs text-gray-600'>Designed for educational purposes.</span>
                </p>
            </div>
        </footer>
    );
