    ...
    useEffect(() => {
        ...
        if (urlCategory) {
            const filtered = healthPackages.filter(p =>
                p.categorySlug && p.categorySlug.toLowerCase() === urlCategory.toLowerCase()
            );
            setFilteredPackages(filtered);
        } else {
            setFilteredPackages(healthPackages);
        }
    }, [healthPackages, urlCategory]);
        ...
        <div className='bg-gray-50 min-h-screen py-10'>
            <div className='section-padding'>
                ...
                <div className='text-center mb-12'>
                    ...
                    <p className='text-gray-500 max-w-2xl mx-auto'>Choose from our wide range of diagnostic tests and health checkup packages. Accurate results guaranteed.</p>
                </div>
